...
#-------SOUND STIMULI-------#
sound {
	wavefile { filename ="DownSweeps_LR.wav"; preload = true; };
} downsweep;
sound {
	wavefile { filename ="UpSweeps_LR.wav"; preload = true; };
} upsweep;
#-------SDL EVENTS ('TRIALS')-------#
trial {
   trial_type = fixed;
...
trial {
   ...
   trial_duration = 20000; 
	nothing {} intersessionevent; 
   code=6; #port_code=3.5;
}intersession;
...
preset int waterAmount_right = 15;
...
display_window.draw_text("Intersession (20 seconds)");
intersession.present();
