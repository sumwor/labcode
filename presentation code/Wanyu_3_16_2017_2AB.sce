...
# 3/16/2017 introduce no lick period again, the duration of the no lick period is drawn from exponential distribution
#-------HEADER PARAMETERS-------#
scenario = "2arm bandit, exp nolick, Wanyu_3_16_2017_2AB";
...
sound {
	wavefile { filename ="whitenoise1sec_wanyu.wav"; preload=true; };
} whitenoise;
...
preset int waterAmount_left = 19;    #   14~3.3uL 2/14/2017
preset int waterAmount_right = 18;
